...
You can install stable-worldmodel directly using:
...
| | |
|---|---|
| **[Basic Usage](basic_usage.md)** | Learn the core API and get started with your first world model experiment. |
| **[Tutorials](tutorial/collect_data.md)** | Step-by-step guides for data collection, training, and adding new environments. |
| **[Environments](environments/pusht.md)** | Explore the included environments: PushT, TwoRoom, OGBench, and more. |
