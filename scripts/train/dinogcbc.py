...
# Model Architecture
# ============================================================================
def get_world_model(cfg):  # TODO: change name to get_gcbc_policy
    ...
    # Build causal predictor (transformer that predicts next latent states)  # TODO: convert predictor to predict action chunks given state and goal
    ...
    )  # TODO: remove, no need for action encoder for BC
    ...
    world_model = (
        swm.wm.DINOWM(  # TODO: convert world model to BC policy model to predict action chunks given state and goal
    ...
    world_model = spt.Module(
        ...
        optim={
            ...
            "action_opt": add_opt(
                "model.action_encoder", cfg.action_encoder_lr
            ),  # TODO: remove, no need for action encoder for BC
        },
    )
    return world_model
...
def run(cfg):
    ...
    manager()
    # TODO: ask Lucas where the training objective is defined
    # TODO: ask if goals are provided
    # TODO: goals should be sampled with HER to improve state-goal coverage
    # TODO: action chunking should be an option for a fair comparison with model-based trajectory planning
