...
class Dict(spaces.Dict):
    ...
    def __init__(
        ...
        init_value: dict[str, Any] | None = None,
        constrain_fn: Callable[[dict[str, Any]], bool] | None = None,
    ...
    @property
    def init_value(self) -> dict[str, Any]:
    ...
    def set_init_value(self, variations_values: dict[str, Any]) -> None:
    ...
    def set_value(self, variations_values: dict[str, Any]) -> None:
